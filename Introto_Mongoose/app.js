...
app.get("/",async (req,res,next)=>{
    ...
    */
   const registeredhouse=await Home.find();
...
// mongoose.connect :- return  a promise so we can acces like the and await




const Dbpath="mongodb+srv://root:abc9818@cluster0.ogkhgbq.mongodb.net/airbnb?appName=Cluster0"
const connectMongoose= async () => {
        try{
            await mongoose.connect(Dbpath);
            app.listen(3001,()=>{
                console.log('moongosse connected ');
